...
#include <memory>
#include "../../../New folder (2)/Student_Login_Form/Student_Login_Form/filehandler.h"
...
QT_MOC_LITERAL(3, 24, 4) // "data"
    ...
    "FileHandler\0saveToFile\0\0data"
};
...
void FileHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->saveToFile((*reinterpret_cast< const QString(*)>(_a[1])));
